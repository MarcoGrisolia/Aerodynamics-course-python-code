...
X_vortex, Y_vortex, U_vortex, V_vortex = f.simpleIrrotational_Vortex( gamma_over2pi= 0 , field_extension = field_width, steps= accuracy_j)
...
c_p , c_l , c_d , cp_function = f.compute_Cp_from_velocity(X,Y,U,V, circle_radius, circle_radius, accuracy, flow_Velocity)

L, D = f.compute_Lift_and_Drag_from_cl_cd(c_d, c_l, accuracy)
